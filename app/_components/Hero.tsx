    ...
    <Section className="py-24 md:py-32 flex flex-col items-center text-center gap-12 mt-2">
      <div className="flex flex-col items-center gap-8 max-w-5xl">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl leading-relaxed animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
          Développeur Full-Stack expert en <span className="text-foreground font-bold underline decoration-[hsl(var(--brand-pink))] decoration-4">Next.js</span> et <span className="text-foreground font-bold underline decoration-[hsl(var(--brand-purple))] decoration-4">Intelligence Artificielle</span>. J&apos;aide les entrepreneurs à transformer leurs idées en produits digitaux à haut ROI.
        </p>
